...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '12-9-16-WEBGL.data';
    var REMOTE_PACKAGE_BASE = '12-9-16-WEBGL.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 5709257;
      var PACKAGE_UUID = 'c6538411-bb1c-4f00-b72d-13aea4b1cc44';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 2933676, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(2933676, 2933985, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(2933985, 2936992, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(2936992, 4806660, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4806660, 5681632, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(5681632, 5709257, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_12-9-16-WEBGL.data');

    };
    Module['addRunDependency']('datafile_12-9-16-WEBGL.data');
